...
// as server and client both are on same port and host so no need of address in io arguemnt
const socket = io()
...
socket.on("GameStarted", (refereeId) => {
   console.log('game started and referee is', refereeId)
